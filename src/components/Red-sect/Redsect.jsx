...
<div className="container">
    <h1 className='h'>Nega bizni tanlashadi</h1>
    <div className="red-sect">
        ...
        <div className="cardd-text">
            <h1>Sifat</h1>
            <p>Barcha assortiment uchun biz 1 yil kafolatini taqdim etamiz, bizda muvofiqlik sertifikati bor!</p>
        </div>
